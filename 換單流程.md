...
graph TD
    ...
    subgraph S2 [主要訂單 & 換單流程]
        ...
        DownKnifeAndCrimperExecution[DownKnifeAndCrimperExecution 下刀線中]
        ...
        WaitForDownKnifeAndCrimper -->|xMachineMode AND xChangeOrder 雙機，且收到換單|DownKnifeAndCrimperExecution

        DownKnifeAndCrimperExecution -->|刀線依序下刀完成，直到InDownKnifeAndCrimper|OrderInExecution
        ...
        InChangeOrder -->|依序上刀，直到 InUpKnifeAndCrimper| OrderChanged
